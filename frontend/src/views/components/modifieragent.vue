      ...
      <div class="modal-content">
        <form role="form" @submit.prevent="ajouter" class="text-start">
                    ...
                    <div class="text-center">
                      <vsud-button @click="modifier(agents.UserId,agents.identifiant,agents.nom,agents.prenom,agents.CIN)"
